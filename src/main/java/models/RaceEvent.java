...
public class RaceEvent {
	 ...
	 * 
	 * @param className
	 *            A string containing the class name that we want to start
	 * @param startTime
	 *            The time that we want the starttimes to be
	 */
	...
	private ArrayList<Participant> sortByPlacement(){
