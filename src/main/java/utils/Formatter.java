...
public class Formatter {
	 ...
	 * @param startTimes list of start times
	 * @param finishTimes list of finish times
	 * @param nameList list of names 
	 * @param lapAmount amount of laps to be displayed
	 * @return
	 */
	...
	/**
	 * returns the amount of laps (determined by parameter) made by parameter participant
	 * @param participant
	 * @param lapAmount
	 * @return
	 */
