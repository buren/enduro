...
public class Formatter {
	...
	public String generateResultList(String pathToStartFile,
		...
		String resultString;
		resultString = generateHeader(pathToStartFile, pathsToFinishFiles,
				pathToNameFile);
	 ...
	 */
	public String generateResultList(String pathToStartFile,
			String[] pathsToFinishFiles, String pathToNameFile, int lapAmount)
			throws FileNotFoundException {
		this.lapAmount = lapAmount;
		String resultString;
		resultString = generateHeader(pathToStartFile, pathsToFinishFiles,
	...
	private String generateResults() {
		...
		for (Participant p : sortedArray) {
			...
			sb.append(p.getId() + "; " + raceEvent.getName(p) + "; ");
