...
public class RaceTest {
	...
	public void testLapRaceCompareTo() {
		...
		lapRace1.addStartTime(new Time("12.00.00"));
		lapRace2.addStartTime(new Time("12.00.00"));
		lapRace1.addFinishTime(new Time("12.30.00"));
		lapRace2.addFinishTime(new Time("12.30.00"));
		assertTrue(lapRace1.compareTo(lapRace2) == 0);
		lapRace1.addFinishTime(new Time("13.00.00"));
		lapRace2.addFinishTime(new Time("12.45.00"));
		assertTrue(lapRace1.compareTo(lapRace2) > 0);
